...
} from "./chunk-B2KWDIPV.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-BFL632LT.js";
import {
  useThemeProps
} from "./chunk-TRWYIH5L.js";
import {
  createSvgIcon,
  useControlled,
  useEventCallback_default,
  useForkRef
} from "./chunk-GY34PCPG.js";
import {
  alpha,
  clsx_default,
  composeClasses,
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React19.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React24.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React24.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  ...
  return (0, import_jsx_runtime7.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime7.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(adapter, now).map((weekday, i) => (0, import_jsx_runtime7.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var MonthCalendarButton = React25.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var MonthCalendar = React27.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React27.useMemo(() => adapter.getMonth(now), [adapter, now]);
  ...
  const [focusedMonth, setFocusedMonth] = React27.useState(() => selectedMonth || adapter.getMonth(referenceDate));
...
var YearCalendarButton = React28.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendar = React29.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React29.useMemo(() => adapter.getYear(now), [adapter, now]);
  ...
  const [focusedYear, setFocusedYear] = React29.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
...
function useValueAndOpenStates(parameters) {
  ...
  } = React38.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React38.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React38.useMemo(() => valueManager.cleanValue(adapter, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [adapter, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React39.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React39.useState(null);
  const popupRef = React39.useRef(null);
  const fieldRef = React39.useRef(null);
  const rootRefObject = React39.useRef(null);
  ...
  const ownerState = React39.useMemo(() => ({
  ...
  const triggerStatus = React39.useMemo(() => {
  ...
  const contextValue = React39.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React39.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React39.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React40.memo(PickersActionBarComponent);
...
var usePickerLayout = (props) => {
  ...
  const ownerState = React42.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersLayout = React43.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime21.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime21.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime21.jsxs)(React43.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime21.jsxs)(React43.Fragment, {
...
var useStaticPicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime22.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime22.jsx)(Layout, _extends({}, slotProps?.layout, {
      slots,
      slotProps,
...
// node_modules/@mui/x-date-pickers/esm/StaticDatePicker/StaticDatePicker.js
var StaticDatePicker = React45.forwardRef(function StaticDatePicker2(inProps, ref) {
